...
<html>
    ...
    <body> 
        <?php
            /*$query = "SELECT * FROM cad_cliente WHERE login ";
        ...
        <div id="site">
            ...
            <div id="cadastro">
                ...
                <center><h1 style="color: white"> Bem vindo ao nosso Reino!</h1></center>
                <center><h2 style="color: white"> Preencha o formulário abaixo para participar do nosso site:</h2><br /></center>

                <a href="login.html"> Se já possui uma conta, faça o login aqui</a>
                        ...
                        <table cellspacing="10">
                            <tr>
                                <td>
                                    ...
                                    <input id="nome" name="name" type="text" title="Preencha o campo Nome" value="<?php echo $nome?>" required /> 
                                </td>
                                <td align="left">
                                </td>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <input name="cpf" type="text" id="CPF" title="Preencha o campo CPF" required size="9"> - <input type="text" name="cpf2" size="2" maxlength="2">
                                </td>
                            </tr>
                        </table>
                    </fieldset>
                    ...
                    <fieldset>
                        ...
                        <table cellspacing="10">
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <input type="text" id="CEP" title="Preencha o campo CEP" required name="cep" size="5" maxlength="5"> - <input type="text" name="cep2" size="3" maxlength="3">
                                </td>
                            </tr>
                        </table>
                    </fieldset>
